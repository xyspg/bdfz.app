                ...
                <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Checkbox.Root
                            ...
                            id="c3"
                            checked={isChecked3}
                            onCheckedChange={()=>{setIsChecked3(!isChecked3)}}
                        >
                            <Checkbox.Indicator className="text-violet11">
                                <CheckIcon />
                            </Checkbox.Indicator>
                    ...
                    <div className="mt-[25px] flex justify-end">
                        <Dialog.Close asChild>
                            <button type='button' onClick={(e)=>{handleSubmit(e).then(()=>setOpen(false))}} className="bg-red4 text-red11 hover:bg-red5 focus:shadow-red7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none focus:shadow-[0_0_0_2px] focus:outline-none">
                                提交
                            </button>
                        </Dialog.Close>
                    </div>
                    <Dialog.Close asChild>
                        <button
                            type='submit'
                            onClick={(e)=>{handleSubmit(e).then(()=>setOpen(false))}}
